...
export const SendTransaction: FC = () => {
  ...
  const onClick = useCallback(async () => {
    ...
    try {
      ...
      // Create a new VersionedTransaction that supports legacy and v0
  ...
  return (
    <div className="flex flex-row justify-center">
      <div className="relative group items-center">
        <div className="m-1 absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg blur opacity-20 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
        <button
